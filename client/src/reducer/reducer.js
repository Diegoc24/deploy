import { GET_BY_NAME, GET_GAMES, GET_GENRES, FILTER_GENRES, ALFA_ORDER, FILTER_CREATED, FILTER_RATING, DETAIL_GAME, POST_GAME, CLEAR_POST, GET_RELEASED } from "../actions/actionsTypes";
